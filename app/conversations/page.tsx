...
export default function FamilyPage() {
  ...
  return <RecallFrame family><div className="care-portal">{!hasFamilyAccess && <RecallHeader family compact />}<AccessGate><FamilyDashboard initialSection="sessions" /></AccessGate></div></RecallFrame>;
}
