...
export const propsSchemas: Record<NodeType, z.ZodType> = {
  ...
  SafetyEvent: z.strictObject({
    category: z.string().min(1),
    at: z.iso.datetime(),
    recipients: z.array(z.string().min(1)),
    alert_id: z.string().min(1),
    acknowledged_at: z.iso.datetime().nullable().default(null),
    acknowledged_by: z.string().min(1).nullable().default(null),
    escalated_at: z.iso.datetime().nullable().default(null),
    escalate_after: z.iso.datetime().nullable().default(null),
    caregiver_id: z.string().min(1),
    caregiver_phone: z.string().nullable().default(null),
    detail_count: z.number().int().nonnegative().nullable().default(null),
  }),
